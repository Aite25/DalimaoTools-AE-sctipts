...
var TrimContentModule = (function() {
    
    var scriptName = "Trim Content";
...
if ($.global.DALIMAO_LOADER_ACTIVE) {
    $.global.DALIMAO_REGISTER(TrimContentModule);
} else {
    (function() {
        var win = new Window("palette", "Trim Content by Aite", undefined, {resizeable:true});
        win.alignChildren = ["fill","top"];
        win.spacing = 10;
        win.margins = 16;
        
        TrimContentModule.buildUI(win);
